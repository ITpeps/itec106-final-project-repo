...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
  <div class="container">
    ...
    <h2 class="title">STUDENT INFORMATION</h2>
       <p class="it-section">INFORMATION TECHNOLOGY 3C</p>
       <hr>
       
       <a class="btn btn-success" href="createforIT3C.php" role="button">
      ...
      <a class="btn btn-info" href="admin.php" role="button">
        ...
        <table class="table table-hover mb-5 table-sm">
            ...
            if($result) {
              while($row = mysqli_fetch_assoc($result)){
                ...
                <td>
                <button>
                <a href='updateforIT3C.php?id=$row[id]'>
                <i class='bi bi-pencil-square'></i></a> </button>
                 &nbsp;
                  <button class='delete-btn'>
                  <a href='deleteforIT3C.php?id=$row[id]'>
            ...
            // it will read data from each row of the database
