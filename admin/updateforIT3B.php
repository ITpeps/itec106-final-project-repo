...
$sql="SELECT * FROM IT3B WHERE id=$id";
...
$sql = "UPDATE IT3B set id=$id, studentNumber='$studentNumber', studentName='$studentName', course='$course', 
            ...
            <form method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="it3b.php" role="button">Cancel</a>
                    </div>
            </form>
    </div>
