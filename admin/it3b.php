...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
  <div class="container">
    ...
    <h2 class="title">STUDENT INFORMATION</h2>
       <p class="it-section">INFORMATION TECHNOLOGY 3B</p>
       <hr>
       
       <a class="btn btn-success" href="createforIT3B.php" role="button">
        ...
        <table class="table table-hover mb-5 table-sm">
            ...
            if($result) {
              while($row = mysqli_fetch_assoc($result)){
                ...
                <td>
                <button>
                <a href='updateforIT3B.php?id=$row[id]'>
                <i class='bi bi-pencil-square'></i></a> </button>
                 &nbsp;
                  <button class='delete-btn'>
                  <a href='deleteforIT3B.php?id=$row[id]'>
