...
// sql is ued to insert the student record to the table 
// after he/she fill up all of the information
...
if($result) {
    echo "<script language = 'javascript'>alert ('New Record has been inserted!')</script>"; //js alert use to notify the student who adds new record
    echo "<script> window.location.href='home.php'; </script>";                             // student will comeback to the home page
} else {
